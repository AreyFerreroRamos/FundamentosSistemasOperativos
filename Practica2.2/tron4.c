...
/*	   $ gcc tron4.c winsuport2.o -o tron4 -lcurses -lpthread	       */
/*	   $ ./tron4 num_oponents variabilitat fitxer [retard] 		       */
/*									       */
/*  Codis de retorn:						  	       */
...
int main(int n_args, const char *ll_args[])
{
  ...
  char a1[20], a2[20], a3[20], a4[20], a5[20], a6[20], a7[20], a8[20], a9[20], a10[20];
  ...
  if (n_args <= 4)
  {	fprintf(stderr,"Comanda: ./tron4 num_oponents variabilitat fitxer [retard]\n");
  ...
  *oponents_morts = 0; 
  ...
  for (i = 0; i < n_oponents; i++) 
  {
	...
	if (tpid_opo[n] == (pid_t) 0) 
	{
		...
		execlp("./oponent4", "oponent4", a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, ll_args[3], (char *) 0);
		fprintf(stderr,"Error: No es pot executar el procés fill \'oponent4\'\n");
		fclose(fitxer);
  		elim_mem(id_camp);
  		elim_mem(id_fi1);
